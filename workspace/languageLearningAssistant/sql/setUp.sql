...
VALUES (1, 'Welcome! Please login below', '', 'Добро пожаловать! Пожалуйста, авторизируйтесь:');
INSERT INTO site_content VALUES (2, 'Login', '', 'Авторизироваться');
...
INSERT INTO site_content VALUES (7, 'email', '', 'email');
INSERT INTO site_content VALUES (8, 'login', '', 'Имя пользователя');
